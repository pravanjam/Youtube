...
# Addon Name: Youtube Serials	
# Addon id: plugin.video.YoutubeSerials
# Addon Provider: VIG
...
URL                 = 'https://raw.githubusercontent.com/pravanjam/YoutubeSerial/YoutubeSerial/'
ADDONTITLE          = 'Youtube Serials'
